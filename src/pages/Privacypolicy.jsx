...
export default function PrivacyPolicy() {
  ...
  const sections = [
    { title: "Information We Collect", text: "We collect personal information including name, contact details, and enquiry-related data when you interact with our website, showroom, or customer support channels." },
    { title: "Purpose of Data Usage", text: "Your information is used to process requests, improve services, communicate updates, and provide personalized offers." },
    { title: "Data Protection & Security", text: "Industry-standard technical and organizational safeguards are implemented to protect your personal data from unauthorized access." },
    { title: "Information Sharing", text: "We do not sell personal data. Limited sharing may occur with authorized service partners or regulatory authorities when legally required." },
    { title: "Policy Updates", text: "This policy may be revised periodically. Continued use of our services implies acceptance of any updates." },
  ];
      ...
      <section className="relative pt-40 pb-28 px-6 border-b border-white/5 text-center">
        ...
        <div className="relative max-w-4xl mx-auto z-10">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-slate-500 mb-4">
            Legal / <span className="text-cyan-400">Privacy Policy</span>
          </p>
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter mb-6">
            Data & <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-400 to-slate-200">Privacy</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg text-slate-400 font-light leading-relaxed">
            At National Auto Sales, transparency and trust guide how we collect, use, and safeguard your telemetry and personal data.
          </p>
        </div>
      </section>

      <section className="py-24 px-6 relative">
        <div className="absolute top-1/2 right-0 w-[400px] h-[400px] bg-blue-600/5 blur-[120px] rounded-full pointer-events-none -translate-y-1/2" />
